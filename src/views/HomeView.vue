...
<template>
  <section id="top" class="hero">
    <div class="hero-copy">
      ...
      <div class="actions">
        ...
        <button class="button secondary" type="button" @click="$emit('openExamples')">Open examples</button>
      </div>
    </div>
  ...
  <section class="section examples-entry">
    ...
    <button class="button primary" type="button" @click="$emit('openExamples')">Open examples</button>
  </section>
