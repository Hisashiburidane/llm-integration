...
const shippingSuggestions = [
  '阿尔萨斯·米奈希尔，13800138000，黑龙江省哈尔滨市道里区冰封大道 9 号。霜之哀伤模型，木箱加固。',
  '伊利丹·怒风，18600001234，上海市浦东新区张江路 88 号。双刃光剑模型，易碎。',
  '亚瑟·摩根，13912345678，内蒙古自治区呼伦贝尔市额尔古纳市黑水镇马掌路 2 号。香烟卡一套，勿折。'
];
